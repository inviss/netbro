...
public class ContentsInstTbl_ {
	public static volatile SingularAttribute<ContentsInstTbl, Long> ctId; //콘텐츠ID
	...
	public static volatile SingularAttribute<ContentsInstTbl, ArchiveTbl> archiveTbl;
	public static volatile SetAttribute<ContentsInstTbl, DownloadTbl> downloadTbl;
