...
//	public static volatile SingularAttribute<EquipmentTbl, String> deviceId;	//장비ID
	...
	public static volatile SingularAttribute<EquipmentTbl, Integer> devicePort;	//장비Port
	...
	//public static volatile SingularAttribute<EquipmentTbl, Integer> deviceNum;	//장비구분코드
	public static volatile SingularAttribute<EquipmentTbl, String> deviceClfCd;	//장비구분코드
	public static volatile SingularAttribute<EquipmentTbl, Integer> prgrs;	//장비구분코드

	public static volatile SetAttribute<EquipmentTbl, TraTbl> tra;	//전송테이블
	public static volatile SetAttribute<EquipmentTbl, TrsTbl> trs;	//변환테이블
	public static volatile SingularAttribute<EquipmentTbl, EquipmentId> id;	//장비구분코드
	public static volatile SingularAttribute<EquipmentTbl.EquipmentId, EquipmentId> deviceId;	//장비ID
	public static volatile SingularAttribute<EquipmentTbl.EquipmentId, EquipmentId> deviceNum;	//장비구분코드
