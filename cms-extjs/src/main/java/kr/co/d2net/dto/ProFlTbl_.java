...
public class ProFlTbl_ {
	public static volatile SingularAttribute<ProFlTbl, Long> proFlId;	//프로파일ID
	...
	public static volatile SetAttribute<ProFlTbl, ProBusiTbl> probusi;	
	public static volatile SetAttribute<ProFlTbl, Opt> opt;
