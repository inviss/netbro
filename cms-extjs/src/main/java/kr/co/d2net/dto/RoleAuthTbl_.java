...
public class RoleAuthTbl_ {
	public static volatile SingularAttribute<RoleAuthTbl.RoleAuthId, Integer> menuId; //메뉴Id
	public static volatile SingularAttribute<RoleAuthTbl.RoleAuthId, Integer> authId; //권한Id
	public static volatile SingularAttribute<RoleAuthTbl, String> controlGubun;	//접근구분
	
	public static volatile SingularAttribute<RoleAuthTbl, RoleAuthTbl.RoleAuthId> id;	
