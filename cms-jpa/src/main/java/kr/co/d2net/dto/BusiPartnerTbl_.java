...
public class BusiPartnerTbl_ {
	public static volatile SingularAttribute<BusiPartnerTbl, Long> busiPartnerId;	//사업자ID
	...
	public static volatile SingularAttribute<BusiPartnerTbl, String> tmpBusiPartnerId;	//tmp비지니스파트너ID
	
	public static volatile SetAttribute<BusiPartnerTbl, BusiPartnerCategoryTbl> busiPartner;
	public static volatile SetAttribute<BusiPartnerTbl, ProBusiTbl> proBusi;
}
