...
public class ContentsTbl_ {
	...
	public static volatile SingularAttribute<ContentsTbl, String> ristClfCd;	//사용등급
	public static volatile SingularAttribute<ContentsTbl, String> categoryNm;	//카테고리명
	
	public static volatile SetAttribute<ContentsTbl, ContentsInstTbl> contentsInst;
	public static volatile SingularAttribute<ContentsTbl, CategoryTbl> categoryTbl;
	public static volatile SingularAttribute<ContentsTbl, SegmentTbl> segmentTbl;
	public static volatile SingularAttribute<ContentsTbl, EpisodeTbl> episodeTbl;
	public static volatile SingularAttribute<ContentsTbl, DisuseInfoTbl> disuseInfoTbl;
