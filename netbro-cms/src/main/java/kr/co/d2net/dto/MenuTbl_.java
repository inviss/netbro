...
public class MenuTbl_ {
	...
	public static volatile SingularAttribute<MenuTbl, Integer> lft;	//좌번호
	public static volatile SingularAttribute<MenuTbl, Integer> rgt;	//우번호
	public static volatile SingularAttribute<MenuTbl, String> url;	//사용여부
}
